...
public class CTA_Facilities_Brochure_Page extends Baselibrary
{
	public CTA_Facilities_Brochure_Page()
	{
		PageFactory.initElements(driver, this);
	}
	
	@FindBy(xpath = "//div[@class='container']/ul/li[7]")
	private WebElement Facilities_Button;
