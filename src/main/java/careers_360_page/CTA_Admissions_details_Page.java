...
public class CTA_Admissions_details_Page extends Baselibrary
{
	public CTA_Admissions_details_Page()
	{
		PageFactory.initElements(driver, this);
	}
	
	@FindBy(xpath = "//div[@class='container']/ul/li[4]")
	private WebElement Admissions_Button;
	@FindBy(xpath = "//div[@class='show_desktop']")
	private WebElement get_Admission;
	@FindBy(xpath = "//div//iframe[@title='registrationModule']")
	private WebElement iframe;
	@FindBy(xpath = "//div[text()='Sign Up']")
	private WebElement Sign_up;
	
	public void clickon_Admissions_Button() 
	{
		clickme(Admissions_Button);
	}

	public void click_On_get_Admission() throws InterruptedException 
	{
		clickme(get_Admission);
		Thread.sleep(2000);
	}
