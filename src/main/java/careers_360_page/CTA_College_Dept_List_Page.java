...
public class CTA_College_Dept_List_Page extends Baselibrary
{
	public CTA_College_Dept_List_Page()
	{
	...
	@FindBy(xpath = "//button[@class='btn_brown_outline btn']")
	private WebElement College_List;
