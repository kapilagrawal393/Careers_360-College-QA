...
public class CTA_Notable_Alumni_Compare_Page extends Baselibrary
{
	public CTA_Notable_Alumni_Compare_Page()
	{
		PageFactory.initElements(driver, this);
	}
	
	@FindBy(xpath="//div[@class='container']/ul/li[9]")
	private WebElement Notable_Alumni;
	@FindBy(xpath="//div[@class='show_desktop']")
	private WebElement Compare	;
	@FindBy(xpath = "//iframe[@id='someFrame']")
	...
	{
		WebElement firstcol = driver.findElement(By.xpath("//input[@id='inputsearchbar2']"));
		firstcol.sendKeys("Indian Institute of Technology Bombay");
	...
	{
		WebElement secondcol = driver.findElement(By.xpath("//input[@id='inputsearchbar3']"));
		secondcol.sendKeys("Indian Institute of Technology Madras");
		Robot robot = new Robot();
		robot.delay(2000);
		robot.keyPress(KeyEvent.VK_DOWN);
		robot.keyRelease(KeyEvent.VK_DOWN);
	...
	{
		WebElement thirdcol = driver.findElement(By.xpath("//input[@id='inputsearchbar4']"));
		thirdcol.sendKeys("Jamia Millia Islamia, New Delhi");
		Robot robot = new Robot();
		robot.delay(2000);
		robot.keyPress(KeyEvent.VK_DOWN);
		robot.keyRelease(KeyEvent.VK_DOWN);
	...
	public static String getReadData(String path,int sheetno,int rowno,int colno) throws IOException
	{
		...
		WebElement choice1=driver.findElement(By.xpath("//div[@id='main-curr-edu-level']/div/div/div/ul/div/div/li/label[contains(text(),'"+option1+"')]"));
