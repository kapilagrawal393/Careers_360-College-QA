...
public class CTA_Facilities_Compare_Page extends Baselibrary
{
	public CTA_Facilities_Compare_Page()
	{
		PageFactory.initElements(driver, this);
	}
	
	@FindBy(xpath="//div[@class='container']/ul/li[7]")
