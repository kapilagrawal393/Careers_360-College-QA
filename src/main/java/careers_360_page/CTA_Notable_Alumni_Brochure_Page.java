...
public class CTA_Notable_Alumni_Brochure_Page extends Baselibrary
{
	public CTA_Notable_Alumni_Brochure_Page()
	{
		PageFactory.initElements(driver, this);
	}
	
	@FindBy(xpath = "//div[@class='container']/ul/li[9]")
	private WebElement Notable_Alumni_Button;
