...
public class CTA_Ques_Ans_Ask_Now_Page extends Baselibrary
{
	
	public CTA_Ques_Ans_Ask_Now_Page()
	{
		PageFactory.initElements(driver, this);
	}
	
	@FindBy(xpath="//div[@class='container']/ul/li[8]")
	private WebElement Q_A;
	@FindBy(xpath="//div[@class='show_desktop']")
	private WebElement Ask_Now;
	@FindBy(xpath="//textarea[@id='description']")
	private WebElement Enter_Fields;
	@FindBy(xpath="//button[@type='submit']")
	private WebElement submit_post;
	...
	{
		Enter_Fields.sendKeys("Best Engineering college in Delhi NCR");
	}
