...
public class CTA_Get_Placement_Page extends Baselibrary
{
	
	public CTA_Get_Placement_Page()
	{
		PageFactory.initElements(driver, this);
	}
	//div[@class="container"]/ul/li[2]/a
	@FindBy(xpath="//div[@class='container']/ul/li[5]")
	private WebElement placement_button;
	@FindBy(xpath="//div[@class='show_desktop']/button")
	private WebElement Get_Placement;
