...
import careers_360_page.CTA_Ques_Ans_Brochure_Page;

public class CTA_Ques_Ans_Brochure_Test extends Baselibrary {
	CTA_Ques_Ans_Brochure_Page ob;
	...
	public void geturllaunch1(String env) 
	{
		...
		ob = new CTA_Ques_Ans_Brochure_Page();
	}

	@Test(priority = 1)
	public void clickon_Q_A_Button() 
	{
		ob.clickon_Q_A_Button();
	}
