...
import careers_360_page.CTA_Facilities_Compare_Page;

public class CTA_Facilities_Compare_Test extends Baselibrary
{
	CTA_Facilities_Compare_Page ob;
	@Parameters("env")
	@BeforeTest
	...
	public void geturllaunch1(String env)
	{
		...
		ob = new CTA_Facilities_Compare_Page();
	}
	
	@Test(priority=1)
	public void clickon_Facilites()
	{
		ob.clickon_Facilites();
	}
	@Test(priority=2)
