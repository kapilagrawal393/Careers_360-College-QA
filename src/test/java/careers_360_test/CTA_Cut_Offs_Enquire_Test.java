...
import careers_360_page.CTA_Cut_Offs_Enquire_Page;

public class CTA_Cut_Offs_Enquire_Test extends Baselibrary
{
	CTA_Cut_Offs_Enquire_Page ob;
	@Parameters("env")
	@BeforeTest
	...
	public void geturllaunch1(String env)
	{
		...
		ob = new CTA_Cut_Offs_Enquire_Page();
	}
