...
import careers_360_page.CTA_Facilities_Brochure_Page;

public class CTA_Facilities_Brochure_Test extends Baselibrary
{
	CTA_Facilities_Brochure_Page ob;
	@Parameters("env")
	@BeforeTest
	...
	public void geturllaunch1(String env)
	{
		...
		ob = new CTA_Facilities_Brochure_Page();
	}
	
	@Test(priority = 1)
	public void clickon_Facilities_Button() 
	{
		ob.clickon_Facilities_Button();
	}
