...
import careers_360_page.CTA_Notable_Alumni_Brochure_Page;

public class CTA_Notable_Alumni_Brochure_Test extends Baselibrary
{
	CTA_Notable_Alumni_Brochure_Page ob;
	@Parameters("env")
	@BeforeTest
	...
	public void geturllaunch1(String env)
	{
		...
		ob = new CTA_Notable_Alumni_Brochure_Page();
	}
	
	@Test(priority = 1)
	public void clickon_Notable_Alumni_Button() 
	{
		ob.clickon_Notable_Alumni_Button();
	}
