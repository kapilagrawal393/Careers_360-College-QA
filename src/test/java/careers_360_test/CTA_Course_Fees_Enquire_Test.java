...
import careers_360_page.CTA_Course_Fees_Enquire_Page;

public class CTA_Course_Fees_Enquire_Test extends Baselibrary
{
	CTA_Course_Fees_Enquire_Page ob;
	@Parameters("env")
	@BeforeTest
	...
	public void get_url_launch1(String env)
	{
		...
		ob = new CTA_Course_Fees_Enquire_Page();
	}
