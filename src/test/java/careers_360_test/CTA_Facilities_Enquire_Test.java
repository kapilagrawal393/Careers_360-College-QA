...
import careers_360_page.CTA_Facilities_Enquire_Page;

public class CTA_Facilities_Enquire_Test extends Baselibrary
{
	CTA_Facilities_Enquire_Page ob;
	@Parameters("env")
	@BeforeTest
	...
	public void geturllaunch1(String env)
	{
		...
		ob = new CTA_Facilities_Enquire_Page();
	}
