...
import careers_360_page.CTA_Ques_Ans_Enquire_Page;

public class CTA_Ques_Ans_Enquire_Test extends Baselibrary
{
	CTA_Ques_Ans_Enquire_Page ob;
	@Parameters("env")
	@BeforeTest
	...
	public void geturllaunch1(String env)
	{
		...
		ob = new CTA_Ques_Ans_Enquire_Page();
	}
