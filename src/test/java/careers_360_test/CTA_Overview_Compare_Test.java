...
import careers_360_page.CTA_Overview_Compare_Page;

public class CTA_Overview_Compare_Test extends Baselibrary
{
	CTA_Overview_Compare_Page ob;
	@Parameters("env")
	@BeforeTest
	...
	public void geturllaunch1(String env)
	{
		...
		ob = new CTA_Overview_Compare_Page();
	}
